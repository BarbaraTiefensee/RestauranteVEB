...
namespace DAO.Migrations
{
    ...
    [Migration("20200312173745_VAIDARBOMDEMONHO1.cs")]
    partial class VAIDARBOMDEMONHO1cs
    {
            ...
            modelBuilder.Entity("DTO.IngredienteDTO", b =>
                {
                    b.HasOne("DTO.IngredienteDTO", null)
                        .WithMany("IngredienteCollection")
                        .HasForeignKey("IngredienteDTOID");

                    b.HasOne("DTO.RefeicaoDTO", null)
                        .WithMany("IngredienteCollection")
                        .HasForeignKey("RefeicaoDTOID");
                });
